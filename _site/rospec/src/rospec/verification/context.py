...
from src.rospec.language.nodes import Connection
from src.rospec.language.ttypes import TType
...
class Context:
    ...
    def add_connections(self, name: str,
                        connections: list[Connection]) -> 'Context':
        copy_ctx = copy.deepcopy(self)
    ...
    def copy_context(self) -> 'Context':
        return Context(typing=copy.deepcopy(self.typing),
