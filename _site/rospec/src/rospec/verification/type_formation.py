from src.rospec.language.ttypes import t_bool, TType, BasicType, RefinedType, OptionalType, StructType, EnumType, \
    ArrayType, AbstractionType, default_types
...
def type_optional(context: Context, ttype: OptionalType):
    ...
    assert is_subtype(
        context, u,
        t), f"Default value {ttype.default_value} not a subtype of {t}"
