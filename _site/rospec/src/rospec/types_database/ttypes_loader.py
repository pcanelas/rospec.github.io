...
from src.rospec.language.frontend import parse_expression
from src.rospec.language.nodes import TypeAlias, Identifier
from src.rospec.language.ttypes import t_float_float_float, t_bool_bool_bool, t_bool_bool, t_float_float_bool, \
    AbstractionType, t_bottom, t_int, t_string, t_bool, ArrayType, StructType, EnumType, t_float, t_plugin
...
def get_native_types(context: Context) -> Context:
    ...
    context.typing['publishers'] = AbstractionType(t_string,
                                                   ArrayType(t_bottom))
    context.typing['subscribers'] = AbstractionType(t_string,
                                                    ArrayType(t_bottom))
