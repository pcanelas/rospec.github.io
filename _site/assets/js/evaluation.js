    ...
    buttons.forEach(function(button) {
      button.addEventListener('click', function() {
        ...
        if (window.getComputedStyle(specRow).display === 'table-row') {
            ...
            this.querySelector('span').textContent = 'Show Specification';
            ...
            btn.querySelector('span').textContent = 'Show Specification';
            btn.classList.remove('active');
            });
            
            // Then show this row
            specRow.style.display = 'table-row';
            this.querySelector('span').textContent = 'Hide Specification';
